...
import com.mynamespace.providerboilerplate.ProviderArgs;
...
@ResourceType(type="pulumi:providers:provider-boilerplate")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("provider-boilerplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
